    ...
    'flex items-center justify-center px-4 py-2 rounded font-medium focus:outline-none focus:ring-2 focus:ring-offset-white dark:focus:ring-offset-black focus:ring-offset-1 disabled:opacity-60 disabled:pointer-events-none hover:bg-opacity-80',
    {
        variants: {
            intent: {
                ...
                secondary:
                    'bg-gray-200 text-gray-900 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-100 focus:ring-gray-500 hover:cursor-pointer',
                danger: 'bg-red-500 text-white focus:ring-red-500 hover:cursor-pointer',
                success: 'bg-teal-400 text-white hover:bg-teal-500 hover:cursor-pointer'
            },
            fullWidth: {
                true: 'w-full',
            },
